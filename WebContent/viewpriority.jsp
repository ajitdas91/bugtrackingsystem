...
<%String logid=(String)session.getAttribute("logid");if(logid==null){ %><jsp:forward page="index.jsp"/><%} %>
   <div class="wrapper">
   		...
   		<center><h1>Bug Tracking System</h1></center>
			...
			PreparedStatement stmt1=con.prepareStatement("select bugid,prodid,prodname,env,priority,description from bug_details where assign_to=? and priority is not null");
			...
			if(status)
			{
				...
				PreparedStatement stmt=con.prepareStatement("select bugid,prodid,prodname,env,priority,description from bug_details where assign_to=? and priority is not null");
