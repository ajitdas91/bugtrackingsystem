...
<%
		...
		PreparedStatement stmt1=con.prepareStatement("update expert set expertname=?  where expertid=?");
		stmt1.setString(1,name);
		stmt1.setInt(2,logid);
		...
		if(i>0)
		{
		response.sendRedirect("eprofile.jsp?message=Update Sucessful !");
		}
 %>
</body>
</html>