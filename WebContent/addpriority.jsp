...
<%String logid=(String)session.getAttribute("logid");if(logid==null){ %><jsp:forward page="index.jsp"/><%} %>
   <div class="wrapper">
   		...
   		<center><h1>Bug Tracking System</h1></center>
			...
			out.print("<td>"+rs.getDate(5)+"</td><td><a href='changepriority.jsp?bugid="+rs.getString(1)+"&prodid="+rs.getString(6)+"&prodname="+rs.getString(3)+"'>change Priority</a></td></tr>");
			}
			out.print("</table>");
			}
			else
   				out.print("Bug Not Available");
			}
